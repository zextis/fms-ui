...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2018 at 04:26 PM
...
(2, 'Screen Request', '2018-03-05 05:00:00', '2018-03-09 01:53:01'),
(3, 'Vehicle Management', '2018-03-09 01:53:24', '2018-03-09 01:53:24'),
(4, 'Driver Management', '2018-03-09 01:53:38', '2018-03-09 01:53:38'),
(5, 'Create/Edit Requests', '2018-03-09 01:54:11', '2018-03-09 01:54:11');
...
INSERT INTO `requests` (`id`, `facility_id`, `license_plate`, `department`, `number_of_persons`, `purpose_of_trip`, `pick_up_point`, `required_date`, `departure_time`, `destination`, `other_info`, `dept_supervisor`, `contact_num`, `request_date`, `request_time`, `approved`, `approval_date`, `driver_id`, `status`, `comments`, `updated_at`) VALUES
(1, 1, '1234 AB', 'MIS', 20, 'Fun and relaxation', 'SRHA', '2018-02-26', '05:00:00', 'Uganda', 'Bring food and beer', 2, '000-000-0000', '2018-02-26', '2018-02-26 14:57:32', 0, NULL, 1, 'Approved', '', '2018-03-12 20:36:49'),
...
(4, 1, '1234 AB', 'HIV', 15, 'Education', 'SRHA', '2018-02-06', '05:00:00', 'Kingston', 'Nope', 1, '000-000-0000', '2018-02-28', '2018-02-28 19:40:17', 0, NULL, 1, 'Approved', '', '2018-03-12 20:36:35'),
(5, 1, NULL, 'Human Resources', 12, 'Training', 'SRHA', '2018-02-17', '08:00:00', 'Montego Bay', '', 1, '000-000-0000', '2018-03-01', '2018-03-01 15:58:04', 0, NULL, NULL, 'Rejected', 'yes', '2018-03-12 19:53:59'),
(6, 1, NULL, 'Xray', 15, 'Meeting', 'MRH', '2018-04-04', '10:00:00', 'Kingston', '', 2, '876-458-7894', '2018-03-09', '2018-03-09 21:13:06', 0, NULL, NULL, 'Rejected', 'no', '2018-03-09 22:22:19'),
(7, 1, '1234 AB', 'MIS', 5, 'field trip', 'SRHA ', '2018-03-17', '09:00:00', 'Kingston', 'yes maybe two', 2, '25555558', '2018-03-09', '2018-03-09 22:25:22', 0, NULL, 1, 'Approved', '', '2018-03-12 20:36:28'),
(8, 1, '1234 AB', 'MIS', 10, 'beach flex', 'SRHA', '2018-03-29', '07:00:00', 'Boston', 'no', 2, '3180533', '2018-03-09', '2018-03-09 22:34:28', 0, NULL, 1, 'Approved', '', '2018-03-12 20:37:26'),
(9, 1, '1234 AB', 'Yum', 26, 'To live', 'Murdock', '2018-03-14', '14:30:00', 'Dum', '', 2, '99802002', '2018-03-12', '2018-03-12 14:08:32', 0, NULL, 1, 'Approved', '', '2018-03-12 20:37:37'),
(10, 1, NULL, 'WOOLO', 3, 'Sho-la!', 'Opron', '2018-06-06', '09:25:00', 'MIS', '', 2, '6672991', '2018-03-12', '2018-03-12 14:11:40', 0, NULL, NULL, 'Pending', NULL, NULL);
...
(2, 'supervisor', '2018-03-05 05:00:00', '2018-03-09 01:54:29'),
(3, 'approver', '2018-03-09 01:54:40', '2018-03-09 01:54:40'),
(4, 'vehicle', '2018-03-09 02:00:15', '2018-03-09 02:00:15'),
(5, 'driver', '2018-03-09 02:00:30', '2018-03-09 02:00:30');
...
(1, 'Admin', 'Istrator', 'Admin', 'admin@srha.gov.jm', '$2y$10$St1VykCotcUMlI21NhXlZ.AZIVfAHUGxEK3mpxAWT82qRF9Sxc3pK', 'power-user', 1, 1, '2018-02-19 17:00:00', '2018-03-08 19:52:28'),
...
(3, 'Sasha', 'Grant', 'sasha', 'sasha_grant@mail.com', '$2y$10$St1VykCotcUMlI21NhXlZ.AZIVfAHUGxEK3mpxAWT82qRF9Sxc3pK', '', 1, 1, '2018-03-06 05:00:00', '2018-03-08 20:01:09');
...
INSERT INTO `vehicles` (`license_plate`, `vehicle_type`, `body_type`, `make`, `model`, `year`, `transmission`, `fuel`, `production_year`, `facility_id`, `engine_number`, `chasis_number`, `colour`, `seating`, `cc_rating`, `fitness_expiration`, `license_expiration`, `next_maintenance`, `is_available`, `is_operable`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `journey_logging`
  ...
  ADD KEY `journey_vehicle_foreign` (`license_plate`);
...
ALTER TABLE `maintenance`
  ...
  ADD KEY `maintenance_vehicle_foreign` (`license_plate`);
...
ALTER TABLE `requests`
  ...
  ADD KEY `request_vehicle_foreign` (`license_plate`),
...
ALTER TABLE `journey_logging`
  ...
  ADD CONSTRAINT `journey_vehicle_foreign` FOREIGN KEY (`license_plate`) REFERENCES `vehicles` (`license_plate`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `maintenance`
  ...
  ADD CONSTRAINT `maintenance_vehicle_foreign` FOREIGN KEY (`license_plate`) REFERENCES `vehicles` (`license_plate`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `requests`
  ...
  ADD CONSTRAINT `request_vehicle_foreign` FOREIGN KEY (`license_plate`) REFERENCES `vehicles` (`license_plate`) ON DELETE CASCADE ON UPDATE CASCADE;
