...
class SongsController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->View->render('songs/index', array('songs' => $songs, 'amount_of_songs' => $amount_of_songs));
    }
    ...
    public function create()
    {
        ...
        if (Request::isset("submit_add_song")) {
            // Instance new Model (Song)
            $Song = new Song();
            // do addSong() in model/model.php
            $Song->addSong(Request::post('artist'), Request::post('track'), Request::post('link'));
        }
    ...
    /**
     * Create a new song object and stores to the database.
     *
     * @return void
     */
    ...
    public function edit($id)
    {
        ...
        if (isset($id)) {
            ...
            $this->View->render('songs/edit', array('song' => $song));
        } else {
    ...
    {
        // if we have POST data to create a new song entry
        if (Request::isset("submit_update_song")) {
            // Instance new Model (Song)
            $Song = new Song();
            // do updateSong() from model/model.php
            $Song->updateSong(Request::post('artist'), Request::post('track'), Request::post('link'), Request::post('song_id'));
        }
