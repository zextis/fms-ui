...
(function($) {
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      var $select = $('<select id="recsOnPage">', {
      ...
      return $('<span />', {
        'class': 'dynatable-per-page in_form'
      }).append("<span class='dynatable-per-page-label'><label for='recsOnPage'>" + settings.inputs.perPageText + "</label></span>").append($select);
    };
